...
public class Xenserver625StorageProcessor extends XenServerStorageProcessor {
    ...
    private SR retrieveAlreadyConfiguredSrWithoutException(Connection conn, String srPath) {
        try {
    ...
    private SR createNewFileSr(Connection conn, String srPath) {
    ...
    private void removeSrAndPbdIfPossible(final Connection conn, SR sr, PBD pbd) {
        if (pbd != null) {
            unplugPbd(conn, pbd);
        }
        if (sr != null) {
    ...
    private SR retrieveAlreadyConfiguredSr(Connection conn, String path) throws XenAPIException, XmlRpcException {
    ...
    private void forgetSr(Connection conn, SR sr) {
    ...
    private void unplugPbd(Connection conn, PBD pbd) {
