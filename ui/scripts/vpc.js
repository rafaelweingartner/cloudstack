...
(function($, cloudStack) {
    ...
    var aclRuleFields = {
            ...
            'protocolnumber': {
                label: 'label.protocol.number.short.label',
    ...
    cloudStack.vpc = {
                                            ...
                                            $.ajax({
                                                ...
                                                success: function(json) {
                                                    ...
                                                    if(jQuery('#details-tab-aclRules').siblings('div.toolbar').children('div.export').size() === 0){
                                                        ...
                                                        var $linkExportAclRulesButtonMessage = jQuery('<a>').html(_l('label.export.ACLs'));
        ...
        routerDetailView: function() {
            return {
                ...
                actions: cloudStack.sections.system.subsections.virtualRouters.listView.detailView.actions,
                tabs: {
