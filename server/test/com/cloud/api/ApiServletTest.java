...
public class ApiServletTest {
    ...
    public void getClientAddressWithXForwardedFor() throws UnknownHostException {
        ...
        Assert.assertEquals("192.168.1.1", ApiServlet.getClientAddress(request).getHostAddress());
    }
    ...
    public void getClientAddressDefault() throws UnknownHostException {
        Mockito.when(request.getRemoteAddr()).thenReturn("127.0.0.1");
        Assert.assertEquals("127.0.0.1", ApiServlet.getClientAddress(request).getHostAddress());
    }
